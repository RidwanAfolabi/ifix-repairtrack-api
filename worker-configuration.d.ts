/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: a9a66840a537bb0f800fbff9c2e40a80)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 
interface __BaseEnv_CloudflareBindings {
	MEDIA: R2Bucket;
	DB: D1Database;
	ALLOWED_ORIGIN: "https://app.ifixexpress.com.my";
	ALIA_WORKER_URL: "https://bot.ifixexpress.com.my";
	REPAIR_CARD_BASE_URL: "https://app.ifixexpress.com.my";
	MEDIA_BASE_URL: "https://api.ifixexpress.com.my";
	JWT_SECRET: string;
}
